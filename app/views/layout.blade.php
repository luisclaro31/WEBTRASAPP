...
<head>
    ...
    <meta name="Hector Luis Claro Gaibao " content="TrasApp Es Una Empresa Dedicada a entregar Sueños">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home')  }}">TrasApp Barranquilla Llt.</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="morris.html">Flot Charts</a>
                                </li>
                                <li>
